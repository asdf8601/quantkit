...
htmlhelp_basename = 'quantkit-doc'
...
latex_documents = [
    (master_doc, 'quantkit.tex', 'quantkit Documentation', 'manual'),
]
...
man_pages = [
    (master_doc, 'quantkit', 'quantkit Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'quantkit', 'quantkit Documentation',
     author, 'quantkit', 'One line description of project.',
     'Miscellaneous'),
]
